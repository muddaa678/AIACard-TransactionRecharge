...
const FrameComponent2: NextPage<FrameComponent2Type> = ({
  ...
  return (
    <div
      className={`w-[14.75rem] flex flex-col items-start justify-start pt-[10.625rem] px-[1.062rem] pb-[27.062rem] box-border relative gap-[9.812rem] text-left text-[0.75rem] text-white font-montserrat mq700:pt-[4.438rem] mq700:pb-[11.438rem] mq700:box-border mq950:hidden mq975:pt-[6.875rem] mq975:pb-[17.563rem] mq975:box-border ${className}`}
    >
      <div className="self-stretch flex flex-col items-start justify-start gap-[2.468rem]">
        ...
        <nav className="m-0 self-stretch flex flex-col items-start justify-start gap-[1.562rem] text-left text-[0.75rem] text-white font-montserrat">
